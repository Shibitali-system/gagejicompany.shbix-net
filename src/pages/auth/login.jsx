  ...
  <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-gray-100 font-sans">
    ...
    <div className="flex flex-col justify-center items-center h-screen p-10 bg-gray-100">
      <div className="
        ...
        shadow-lg border-4 border-[#3360C3]
      ...
      ">
        ...
        <div className="
          ...
          ring-4 ring-[#3360C3] ring-opacity-20 rounded-2xl
    ...
    <div className="flex flex-col justify-center items-center h-screen px-6 bg-gray-100">
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        {/* Login Form Card */}
        <FormCard title="Taarifa za Kuingia">
          <form className="space-y-5">
            <div className="flex flex-col gap-1">
              <label className="font-medium text-gray-600 text-sm">Barua Pepe</label>
              <input
                type="email"
                value={email}
                ...
                className="
                  ...
                  focus:outline-none focus:ring-2 focus:ring-[#3360C3]
            ...
            <div className="flex flex-col gap-1 relative">
              <label className="font-medium text-gray-600 text-sm">Nenosiri</label>
              <input
          ...
          <button
            ...
            disabled={loading}
            className="
              w-full bg-[#3360C3] text-white font-semibold py-2 rounded-md
              shadow hover:bg-[#274998] transition
          ...
          <button
            onClick={() => navigate("/")}
            className="mt-5 w-full text-center text-[#3360C3] font-medium text-sm hover:underline"
          >
